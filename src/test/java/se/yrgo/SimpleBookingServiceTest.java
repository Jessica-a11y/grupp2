...
public class SimpleBookingServiceTest {
    ...
    public void updateReservation() {
        ...
        Reservation updatedReservation = new Reservation("R1", newTable, newCustomer, LocalDate.parse("2024-01-20"), LocalTime.parse("18:30"));
        service.updateReservation(updatedReservation.getReservationId(), String.valueOf(updatedReservation.getReservationDate()), String.valueOf(updatedReservation.getReservationTime()));
        assertEquals(1, reservationService.getAllReservations().size());
    }
