 ...
 * 
 * <p>
 * This interface provides methods for creating, updating, deleting and searching for reservations,
...
public interface BookingService {
     ...
     * @throws TableNotAvaliableException if no table is avaliable for the specifies date, time and number of seats
     * @throws ReservationNotAvaliable if the reservation cannot be made for other reasons
     */
     ...
     * 
     * <p>
     * The specific implementation and return type should be defined in the implementing class.
     * </p>
     */
